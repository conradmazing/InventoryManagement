 ...
 */
public class NProducts extends javax.swing.JFrame {
    ...
    public void refresh(){
        //Load data
        if(Methods.openDB()){
            String[] columns = {"ProductID", "ProductName", "Quantity", "Price"};
            String[][] records = Methods.read("NProducts",columns);
                ...
                public void valueChanged(javax.swing.event.ListSelectionEvent event) {
                    if (tblLogs.getSelectedRow() > -1) {
                        ...
                        if(Methods.openDB()){
                            ...
                            String[][] result = Methods.read("NProducts", "ProductID=" + id);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog(this, "Would you like to delete supply??", "Delete Supply", dialogButton);
        if(dialogResult == JOptionPane.YES_OPTION) {
            if(Methods.openDB()){
                int id = Integer.parseInt(txtProdID.getText());
                if(Methods.deleteproduct("NProducts", id)){
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        int id = Integer.parseInt(txtProdID.getText());
            if(Methods.openDB()){
            String[] column = {"ProductID", "ProductName", "Quantity", "Price"};
            String[][] data = Methods.searchsupply("NProducts", id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NProducts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
