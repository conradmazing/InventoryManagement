 ...
 */
public class StockInLogs extends javax.swing.JFrame {
    ...
    public void refresh(){
        //Load data
        if(Methods.openDB()){
            String[] columns = {"Date", "ProductID", "Quantity", "EmployeeID", "BeginningSteam"};
            String[][] records = Methods.read("PStockIn",columns);
    ...
    private void initComponents() {
        ...
        setTitle("Product Stock In Logs");
        setResizable(false);
        ...
        tblLogs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "ProductID", "Quantity", "EmployeeID", "BeginningSteam"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockInLogs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
