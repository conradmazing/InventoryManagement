 ...
 */
public class StockOutLogs extends javax.swing.JFrame {
    ...
    public void refresh(){
        //Load data
        if(Methods.openDB()){
            String[] columns = {"Date", "ProductID", "Quantity", "EmployeeID", "EndingSteam", "StockOutStatus"};
            String[][] records = Methods.read("PStockOut",columns);
    ...
    private void initComponents() {
        ...
        setTitle("Product Stock Out Logs");
        setResizable(false);
        ...
        tblLogs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "ProductID", "Quantity", "EmployeeID", "EndingSteam", "StockOutStatus"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockOutLogs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
